...
const quotePageSchema = {
  ...
  "@type": "WebPage",
  name: "Request a Quote — Iron & Hardware",
  description: `Request a quote for iron, steel, pipes, wire mesh, barbed wire, chain link, and construction hardware. ${site.name} — Siyaganj, Indore. Retail and wholesale.`,
  url: `${baseUrl}/quote`,
};
