...
export const categories: Category[] = [
  ...
  },
  {
    ...
    description: "GI and MS perforated sheets for screening and filtration.",
    icon: "Grid3X3",
    products: [
      {
        slug: "gi-perforated-sheet",
        name: "GI Perforated Sheet",
        shortDesc: "Galvanized iron perforated sheets for screening, ventilation, and filtration.",
        categorySlug: "perforated-sheets",
        specs: [
          { label: "Material", value: "Galvanized iron (GI)" },
          { label: "Thickness", value: "0.5 mm to 3 mm" },
          { label: "Hole pattern", value: "Round, square, slot, hexagonal" },
        ],
        images: ["/products/gi-perforated-1.png", "/products/gi-perforated-2.png", "/products/gi-perforated-3.png"],
        image: "/products/gi-perforated-1.png",
        imageAlt: "GI perforated sheet with circular and pattern perforations",
        useCases: ["Screens", "Ventilation", "Filtration", "Architectural"],
        variants: ["Round holes", "Square holes", "Slot holes", "Hexagonal"],
        materials: ["Galvanized iron"],
        notes: "GI perforated sheets in different thicknesses and hole patterns. Corrosion-resistant. Custom sizes available.",
        indicativeRate: "Approx. ₹120–220 per sq m (varies by thickness and pattern). Confirm for current price.",
      },
      {
        slug: "ms-perforated-sheet",
        name: "MS Perforated Sheet",
        shortDesc: "Mild steel perforated sheets for screening and filtration.",
        categorySlug: "perforated-sheets",
        specs: [
          { label: "Material", value: "Mild steel (MS)" },
          { label: "Thickness", value: "0.5 mm to 3 mm" },
        ...
        imageAlt: "MS perforated sheet",
        useCases: ["Screens", "Ventilation", "Filtration"],
        variants: ["Round holes", "Square holes", "Slot holes"],
        materials: ["Mild steel"],
        notes: "MS perforated sheets in different thicknesses and hole patterns. Custom sizes available.",
        indicativeRate: "Approx. ₹120–220 per sq m (varies by thickness and pattern). Confirm for current price.",
      },
    ],
  },
    ...
    products: [
      {
        ...
        /** First two images are local product photos; rest are brand (Tata). */
        images: [
          "/products/gi-wire-local-1.png",
          "/products/gi-wire-local-2.png",
          "/products/tata-gi-wire-1.png",
          "/products/tata-gi-wire-2.png",
        ],
      ...
      },
      {
        ...
        images: ["/products/binding-wire-main.png", "/products/binding-wire.png"],
        image: "/products/binding-wire-main.png",
        imageAlt: "Binding wire coils for RCC tying",
      ...
      },
      {
        ...
        images: ["/products/concertina-wire-main.png", "/products/concertina-wire-1.png"],
        image: "/products/concertina-wire-main.png",
        imageAlt: "Concertina razor wire barrier",
    ...
    products: [
      {
        ...
        images: ["/products/fiber-mesh-main.png", "/products/fiber-mesh-1.png", "/products/fiber-mesh-2.png", "/products/fiber-mesh-3.png"],
