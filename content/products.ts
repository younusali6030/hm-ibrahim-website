    ...
    products: [
      {
        slug: "gi-wire",
        name: "GI Wire",
        shortDesc: "Galvanized iron wire for binding, fencing, and general use. Available in Local stock and Tata Wiron.",
        categorySlug: "wires",
        specs: [{ label: "Gauge", value: "8 SWG to 18 SWG" }],
        images: ["/products/gi-wire-local-1.png", "/products/gi-wire-local-2.png"],
        ...
        notes: "GI wire available in coils. Choose Local or Tata Wiron. Contact us for gauge and quantity.",
        tataAvailable: true,
        tataOfficial: true,
        brandVariants: [
          {
            ...
            images: ["/products/gi-wire-local-1.png", "/products/gi-wire-local-2.png"],
            specs: [
              { label: "Type", value: "Local GI wire" },
            ...
            notes: "Local GI wire in coils. Quality stock for binding and fencing. Contact us for gauge and quantity.",
          },
          {
            brandId: "tata",
