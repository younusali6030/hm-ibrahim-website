...
export const categories: Category[] = [
  ...
  },
  {
    slug: "welded-mesh",
    name: "Welded Mesh",
    description: "G.I & MS welded mesh for reinforcement and partitioning.",
    icon: "Grid3X3",
    products: [
      {
        slug: "welded-mesh",
        name: "G.I & MS Welded Mesh",
        ...
        images: ["/products/welded-wire-mesh-1.png", "/products/welded-wire-mesh-2.png"],
        useCases: ["RCC slabs", "Partition", "Cages"],
        sizes: ["15mm x 15mm", "50x50mm", "75x75mm", "100x100mm", "150x150mm"],
        materials: ["Mild steel wire", "GI wire"],
        notes: "Available in different mesh sizes and wire diameters. Used for RCC slab reinforcement, partitions, and cages.",
    ...
    products: [
      {
        slug: "gi-wire",
        name: "MS and GI Wire",
        shortDesc: "Galvanized iron wire and mild steel wire for binding, fencing, and general use. Available in CM, Border, and Tata Wiron.",
        categorySlug: "wires",
        ...
        image: "/products/gi-wire.png",
        imageAlt: "MS and GI wire coils",
        sizes: ["8 SWG", "10 SWG", "12 SWG", "14 SWG", "16 SWG", "18 SWG"],
        materials: ["Galvanized iron", "Mild steel"],
        useCases: ["Binding", "Fencing", "General purpose", "Agricultural use"],
        notes: "GI wire and MS wire available in coils. CM, Border, and Tata Wiron brands. Contact us for gauge and quantity.",
        tataAvailable: true,
        tataOfficial: true,
        brandVariants: [
          {
            ...
            specs: [
              { label: "Brand", value: "CM" },
              { label: "Gauge", value: "8 SWG to 18 SWG" },
              { label: "Finish", value: "GI / MS" },
            ],
            sizes: ["8 SWG", "10 SWG", "12 SWG", "14 SWG", "16 SWG", "18 SWG"],
            materials: ["Galvanized iron", "Mild steel"],
            useCases: ["Binding", "Fencing", "General purpose"],
            notes: "CM brand MS and GI wire. Coils as per stock.",
          },
          {
            brandId: "boarder",
            images: ["/products/gi-wire.png"],
            specs: [
              { label: "Brand", value: "Border" },
              { label: "Gauge", value: "8 SWG to 18 SWG" },
              { label: "Finish", value: "GI / MS" },
            ],
            sizes: ["8 SWG", "10 SWG", "12 SWG", "14 SWG", "16 SWG", "18 SWG"],
            materials: ["Galvanized iron", "Mild steel"],
            useCases: ["Binding", "Fencing", "General purpose"],
            notes: "Border brand MS and GI wire. Coils as per stock.",
          },
          {
            brandId: "tata",
      ...
      {
        slug: "wire-rope",
        name: "MS & G.I Wire Rope",
        shortDesc: "Steel wire rope for lifting, tying, and industrial use.",
        categorySlug: "wires",
        specs: [{ label: "Diameter", value: "2 mm to 20+ mm" }],
        images: ["/products/gi-wire.png"],
        image: "/products/gi-wire.png",
        useCases: ["Hoisting", "Rigging", "Pulling"],
        materials: ["Steel", "Galvanized"],
        notes: "Wire rope supplied by meter or coil. Contact us for diameter and length.",
  ...
  },
  {
    ...
    description: "Crowbar, Hoe (Phawda), Pickaxe (Geti), Shikanja, Coverblock, welding rods, sponge, cutting disc.",
    icon: "Wrench",
    products: [
      {
        slug: "sr-crowbar",
