...
export const indorePages: Record<IndorePageSlug, IndorePage> = {
  ...
  "barbed-wire": {
    ...
    intro2: "Our in-house brands CM and Boarder offer trusted barbed wire options. Tell us your length and height requirements for a quote.",
    specs: [
